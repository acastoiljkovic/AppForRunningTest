...
public class UpdateKorisnikService extends AsyncTask<String,Void,String> {

    Fragment fragment;

    public UpdateKorisnikService(Fragment fragment){
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            URL url = new URL(Constants.URL+"/"+Constants.UPDATE_KORISNIK);
    ...
    protected void onPostExecute(String s) {
        if(s.equals("Success")){
            ((FragmentEditProfile)fragment).successUpdate();
        }
        else
            ((FragmentEditProfile)fragment).failedUpdate();
    }
}
