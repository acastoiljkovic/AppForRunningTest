...
public class RemoveFriendService extends AsyncTask<String,Void,String> {

    Fragment fragment;

    public RemoveFriendService(Fragment fragment){
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            URL url = new URL(Constants.URL+"/"+Constants.REMOVE_FRIEND);
    ...
    protected void onPostExecute(String s) {
        if(s.equals("Success")){
            ((FragmentProfileFriend)fragment).removeKorisnikSuccess();
        }
        else {
            ((FragmentProfileFriend)fragment).removeKorisnikFailed();
        }
    }
}